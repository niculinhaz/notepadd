...
import { NoteCard, Note } from '../../components/ui/note-card';
import { FilterDrawer } from '../../components/ui/filter-drawer';

const STORAGE_KEY = '@my_notes_app_final_v2';
...
export default function NotesScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      {/* BUSCA (SEM O ÍCONE DE FILTRO AGORA) */}
      ...
      {/* INFO ROW (AQUI FICA A ORDENAÇÃO) */}
